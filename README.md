...
<!-- BEGIN SCREENSHOTS -->
![Inbox](docs/screenshots/1-inbox.png)

![Reading A Message](docs/screenshots/2-reading-a-message.png)

![Composing](docs/screenshots/3-composing.png)

![Settings](docs/screenshots/4-settings.png)

![Filters](docs/screenshots/5-filters.png)

![Address Book](docs/screenshots/6-address-book.png)
